new Vue({
    ...
    data: {
        ...
        defaultThumbnail: articlesFormData.defaultThumbnail,
        imageSrc: articlesFormData.imageSrc,
        imageSelected: Boolean(articlesFormData.imageSrc)
    },
    ...
    ready: function()
    {
        ...
        if (typeof articlesFormData.tags !== 'undefined') {
            $('.js-article-tags').tagsinput({
                confirmKeys: [13, 44],
                typeahead: {
                    afterSelect: function (val) {
                        this.$element.val("");
                    },
                    source: articlesFormData.tags
                },
                freeInput: true,
                trimValue: true
            });
        ...
        CKEDITOR.replace( 'editor-full',{
            filebrowserImageBrowseUrl: articlesFormData.filebrowserImageBrowseUrl,
            filebrowserImageUploadUrl: articlesFormData.filebrowserImageUploadUrl,
            filebrowserBrowseUrl: articlesFormData.filebrowserBrowseUrl,
            filebrowserUploadUrl: articlesFormData.filebrowserUploadUrl,
        ...
        $(".tree-checkbox").fancytree({
            ...
            icon: false,
            source: {
                url: this.laravel.categoriesTreeUrl
            },
            select: function(event, data) {
                ...
                $("#categories_imploded").val(selKeys.join(","));
            }
        });
