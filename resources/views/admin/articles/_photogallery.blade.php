...
<div class="panel panel-white">
    ...
    <table class="table table-striped media-library table-lg">
        ...
        @foreach ($photos as $p)
            <tr>
                <td>
                    <a href="{{ $article->photos_url . '/big/' . $p->image  }}" data-popup="lightbox">
                        <img src="{{ $article->photos_url . '/small/' . $p->image }}" alt="" class="img-rounded img-preview">
                    </a>
                </td>
                ...
                <td class="text-center">
                    ...
                    <a class="delete-photo" href="{{ route('admin.articles.photo.delete', $p->id) }}">
